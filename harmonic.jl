...
# ╔═╡ aebab1f6-4292-453f-afe5-c956118f919b
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 94bb5440-6ad0-11ed-203c-4be9e445a05e
md"# Simple Harmonic Motion"

# ╔═╡ 9beac3a6-e318-407f-98b9-07b365c8612e
md"Source: [Wikipedia Article](https://en.wikipedia.org/wiki/Simple_harmonic_motion)

# ╔═╡ ec4097ea-69a9-4d34-932f-af10d732cca5
md"## Describe Problem"

# ╔═╡ 8623b916-ef28-4454-95a2-0b5d7537ba74
md"### Second Order Ordinary Differential Equation"

# ╔═╡ 16dee440-fc6b-45c3-8b4d-6e9dfe07ddd3


# ╔═╡ 122f2247-25eb-417d-bb5f-9c9bf4f9b008
md"From Hooke's Law:"

# ╔═╡ de454a5d-1163-4199-a2bc-7778beb2f41c
md"$F_s = -kx$"

# ╔═╡ 49eab6ca-8974-4daf-bf0e-60ac9daa7545
md"From Newton's Second Law of Motion:"

# ╔═╡ 9404f774-9f0e-4f98-9519-a8bffc16dddc
md"$F = ma$"

# ╔═╡ c4ff8d44-831d-44b6-9a72-30e03a5306d7
md"$a = \frac{d^2x}{dt^2}$"

# ╔═╡ 55e71c5e-c3c5-4118-ba05-d2a1a2aaa717
md"$F = m \frac{d^2x}{dt^2} = -kx$"

# ╔═╡ 56976c9a-8f44-4923-9c75-daedfb509542
md"$\frac{d^2x}{dt^2} = - \frac{k}{m} x$"

# ╔═╡ ec358106-85d7-42b4-9069-13aff73e9ae1
md"#### DifferentialEquations.jl"

# ╔═╡ d3d44937-218e-4179-a9a8-615a528e55e9
md"$\frac{d^2u}{dt^2} = f(du, u, p, t)$"

# ╔═╡ e5f0932a-d8ac-4191-a817-011a254e5d7f
md"##### Simple Harmonic Motion Problem"

# ╔═╡ 98855dd4-56fc-4f70-8d83-8a2a00536cbb
md"$f(du, u, p, t) = - \frac{p[1]}{p[2]} u$"

# ╔═╡ 9002b154-4833-4546-86be-5aa9a8beadda
md"## Define Julia Function"

# ╔═╡ ad8b92ed-4f6d-4cd8-8b5e-3fe157790ffd
...
# ╔═╡ 82b400c8-d65a-45fc-a544-ef316cbcedb0
md"## Assign Variables"

# ╔═╡ 4d3eb24a-c033-4a94-96d3-05147ab17be5
md"### du: Velocity in Meters per Second"

# ╔═╡ 08895d23-b99c-43c1-b99e-823a2f9f6822
dx_begin = 0.0

# ╔═╡ 678193e7-1ac9-446c-a0f9-497b2f0287cd
md"### u: Position in Meters"

# ╔═╡ 765b279f-d6f5-47a0-b1e7-bca26db2ba3d
md"### p: Parameters"

# ╔═╡ d8f21545-859d-415e-95be-e494326e5941
md"#### k: Spring Constant in Newtons per Meter"

# ╔═╡ ef90e8d3-5466-4460-9678-49db04f8ea2f
md"#### m: Mass in Kilograms"

# ╔═╡ 591575c7-1be7-4f05-8ae3-6076fe33597f
md"### t: Time in Seconds"

# ╔═╡ 8c798c28-5070-4ba9-8a37-499e5786eab5
t_begin = 0.0

# ╔═╡ 190a5b59-d095-4fd0-9a88-d7d95b7d0a8e
md"## Define Second Order ODE Problem"

# ╔═╡ 79d20e30-7d3b-46d4-99ba-8943a3840f39
md"## Solve Problem"

# ╔═╡ 9851e6a8-4756-4403-8437-4c8a5165a5f6
md"## Plot Solution"

# ╔═╡ 167e6fc6-e70b-4984-8360-d24dfcd2353d
@bind reset Button("Reset Sliders")

# ╔═╡ 17550280-df4d-426a-b93b-0e140c69098a
begin
	reset
	md"""
	Time (seconds): $(@bind t_end Slider(0.0:0.01:20.0, 20.0, true)) |
	Initial Position (m): $(@bind x_begin Slider(-0.25:0.01:0.25, 0.25, true))
	"""
end

# ╔═╡ d3f431e4-3e0c-4c58-8036-e35f77ad890b
tspan = (t_begin, t_end)

# ╔═╡ 1c70902f-819f-4341-b47c-08238856dc08
begin
	reset
	md"""
...
# ╔═╡ 5e8ab4c7-c43d-4356-9cb2-9058964e4f8b
p = [k, m]

# ╔═╡ 9a1b0e0b-99d3-433d-9b34-1468ebbd2c47
prob = SecondOrderODEProblem(harmonic, dx_begin, x_begin, tspan, p)

# ╔═╡ c0b9a0c6-49b2-43a0-bb74-6e58a37a37c6
sol = solve(prob)

# ╔═╡ 148ee458-2cd4-418a-a1d9-1761fa178c30
position = sol(t_end)[2]

# ╔═╡ d30529e1-14e4-4e03-b34a-3b112623ba88
velocity = sol(t_end)[1]

# ╔═╡ 468c7bd9-7e82-47bf-9416-e74302c75d3b
...
# ╔═╡ 06ee5f00-0ef7-41dc-81de-efcfb5362ab6
acceleration = -k / m * position

# ╔═╡ 3950bc74-8748-4ac2-a0ec-f8b474f29f3d
scatter!(phase, (position, velocity), color = :red, markersize = 5)

# ╔═╡ 83f57143-a61d-40b7-b060-8d57b718dde7
plot(sol,
	legend = (0.8, 0.09),
	linewidth = 2,
...
# ╔═╡ 00b52893-eae0-427e-a4dc-91707257bf95
md"## Appendix: Period (T)"

# ╔═╡ 52db516a-4c27-4c8e-b58f-7ba7532e3372
md"$T = 2 \pi \sqrt{\frac{m}{k}}$"

# ╔═╡ 0bd1b851-7e89-450b-a070-eca7093d1002
period = 2 * pi * sqrt(m / k)

# ╔═╡ 555443ae-2c23-496b-9fe1-1bb4cc3d38d6
md"""
...
# ╔═╡ f18be091-a5f5-4bed-af95-92346e03f445
md"##### Thanks for reading!"

# ╔═╡ 270abb82-cd54-4601-8d76-4c7b84f4f8cb
md"##### sootynemm"

# ╔═╡ 53ef40f0-be1a-4121-80d2-af85ace42fef
